...
class Application
{
	...
	private function createControllerAndActionNames()
	{
		...
		$this->controller_name = ucwords($this->controller_name) . 'Controller';
                ...
                // check for parameter: no parameter? then make parameter = default parameter (from config)
		if (!$this->parameters) {
                    
			//$this->parameters = Config::get('DEFAULT_PARAMETERS');
                    $default_param = array(Config::get('DEFAULT_PARAMETERS'));
                    $this->parameters = $default_param;
		}
