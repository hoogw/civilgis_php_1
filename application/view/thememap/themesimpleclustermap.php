...
<script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/localmapjs/localsimpleclustermap.js"></script>
                        ...
                        <div class="row">
                                <div id="breadcrumb" class="col-md-12">
                                        <ol class="breadcrumb">
                                              ...
                                              <!--  <li><a href="<?php echo Config::get('URL'); ?>thememap/thememaplistpaged/<?php echo $data['area'] ?>"><?php echo $data['area'] ?></a></li>  -->
                                                  <li><a href="<?php echo Config::get('URL'); ?>thememap/thememaplistscroller/<?php echo $data['area'] ?>"><?php echo $data['area'] ?></a></li> 
                                                
                                               
                                                
                                                <li><a href="<?php echo Config::get('URL'); ?>thememap/thememaponly/<?php echo $data['area'] ?>/<?php echo $data['subject'] ?>"><?php echo $data['subject'] ?></a></li>
                                        </ol>
                                </div>
                        </div>
