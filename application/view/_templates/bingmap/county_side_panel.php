			...
			<ul class="nav main-menu">
					...
					<a href="<?php echo Config::get('URL'); ?>home/bingmap/<?php echo $data['area'] ?>">
						...
						<span class="hidden-xs">  <?php echo $data['area'] ?>  &nbsp; &nbsp;&nbsp; <img src="<?php echo Config::get('URL'); ?>public/images/logo/bing-map-icon.png" alt=""/>  Map</span>
                                ...
                                <li>
					<a href="<?php echo Config::get('URL'); ?>bingmap/scrollerclienttablemap/county/cities" >
						...
						<span class="hidden-xs">Cities</span>
                                ...
                                <li>
					<a href="<?php echo Config::get('URL'); ?>bingmap/simplemap/county/rails" >
						...
						<span class="hidden-xs">Rails</span>
                                ...
                                <li>
					<a href="<?php echo Config::get('URL'); ?>bingmap/scrollerclienttablemap/county/parks" >
						...
						<span class="hidden-xs">Parks</span>
                                ...
                                <li>
					<a href="<?php echo Config::get('URL'); ?>bingmap/simplemap/county/water" >
						...
						<span class="hidden-xs">Water</span>
                                ...
                                <li>
					<a href="<?php echo Config::get('URL'); ?>bingmap/clusterscrollerclienttablemap/county/education_facility" >
				...
				<li>
					<a href="<?php echo Config::get('URL'); ?>bingmap/simplemap/county/hospitals" >
						...
						<span class="hidden-xs"> Hospitals</span>
                                 ...
                                 <li>
					<a href="<?php echo Config::get('URL'); ?>bingmap/clusterscrollerclienttablemap/county/fire_stations" >
