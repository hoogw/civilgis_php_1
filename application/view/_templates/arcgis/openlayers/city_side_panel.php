			...
			<ul class="nav main-menu">
					...
					<a href="<?php echo Config::get('URL'); ?>home/arcgis/openlayers/<?php echo $data['area'] ?>">
						...
						<span class="hidden-xs"> <?php echo $data['area'] ?>  &nbsp; &nbsp;ESRI ArcGIS Server Rest API + &nbsp; <img src="<?php echo Config::get('URL'); ?>public/images/logo/openlayers.png" alt=""/>  Map </span>
                                ...
                                <li>
					<a href="<?php echo Config::get('URL'); ?>arcgis/scrollerfulltablemap/openlayers/city/parcels" >
						...
						<span class="hidden-xs">Parcels</span>
                                ...
                                <li>
					<a href="<?php echo Config::get('URL'); ?>arcgis/scrollerfulltablemap/openlayers/city/address" >
						...
						<span class="hidden-xs"> Address</span>
                                ...
                                <li>
					<a href="<?php echo Config::get('URL'); ?>arcgis/scrollerfulltablemap/openlayers/city/streets" >
						...
						<span class="hidden-xs"> Streets</span>
                                ...
                                <li>
					<a href="<?php echo Config::get('URL'); ?>arcgis/classifycheckboxbuttonmap/openlayers/city/zoning" >
						...
						<span class="hidden-xs">Zoning(check box)</span>
                                ...
                                <li>
					<a href="<?php echo Config::get('URL'); ?>arcgis/classifyradiobuttonmap/openlayers/city/zoning" >
						...
						<span class="hidden-xs">Zoning(radio)</span>
                                ...
                                <li>
					<a href="<?php echo Config::get('URL'); ?>arcgis/classifycheckboxbuttonmap/openlayers/city/general_land_use" >
						...
						<span class="hidden-xs">General land use (check box)</span>
                                ...
                                <li>
					<a href="<?php echo Config::get('URL'); ?>arcgis/classifyradiobuttonmap/openlayers/city/general_land_use" >
				...
				<li>
					<a href="<?php echo Config::get('URL'); ?>arcgis/simplemap/openlayers/city/neighbor" >
						...
						<span class="hidden-xs"> Neighbor</span>
                                 ...
                                 <li>
					<a href="<?php echo Config::get('URL'); ?>arcgis/scrollerclienttablemap/openlayers/city/parks" >
						...
						<span class="hidden-xs"> Parks</span>
                                ...
                                <li>
					<a href="<?php echo Config::get('URL'); ?>arcgis/scrollerclienttablemap/openlayers/city/schools" >
