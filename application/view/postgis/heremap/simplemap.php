...
<script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/mongodb/heremap/simplemap.js"></script>
                                ...
                                <div id="breadcrumb" class="col-md-12">
                                        <ol class="breadcrumb">
                                               ...
                                               <li><a href="<?php echo Config::get('URL'); ?>home/mongodb/heremap/<?php echo $data['area'] ?>/"><?php echo $data['area'] ?></a></li>
                                                ...
                                                <li><a href="<?php echo Config::get('URL'); ?>mongodb/simplemap/heremap/<?php echo $data['area'] ?>/<?php echo $data['subject'] ?>"><?php echo $data['subject'] ?></a></li>
                                        </ol>
                                </div>
                        </div>
