...
<script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/mongodb/heremap/simpleclustermap.js"></script>
                                ...
                                <div id="breadcrumb" class="col-md-12">
                                        <ol class="breadcrumb">
                                               <li><a href="<?php echo Config::get('URL'); ?>map/index/">Transparent Gov</a></li>
                                                ...
                                                <li><a href="<?php echo Config::get('URL'); ?>mongodb/simpleclustermap/heremap/<?php echo $data['area'] ?>/<?php echo $data['subject'] ?>"><?php echo $data['subject'] ?></a></li>
                                        </ol>
                                </div>
                        </div>
