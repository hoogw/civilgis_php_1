...
<script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/mongodb/googlemap/classifyradiobuttonmap.js"></script>
                                ...
                                <div id="breadcrumb" class="col-md-12">
                                        <ol class="breadcrumb">
                                               ...
                                               <li><a href="<?php echo Config::get('URL'); ?>home/mongodb/googlemap/<?php echo $data['area'] ?>/"><?php echo $data['area'] ?></a></li>
                                                ...
                                                <li><a href="<?php echo Config::get('URL'); ?>mongodb/classifyradiobuttonmap/googlemap/<?php echo $data['area'] ?>/<?php echo $data['subject'] ?>"><?php echo $data['subject'] ?></a></li>
                                        </ol>
                                </div>
                        </div>
