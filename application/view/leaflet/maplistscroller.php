         ...
         <!-- our js -->
         <script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/leaflet/maplist_scroller.js"></script>
                        ...
                        <div class="row">
                                <div id="breadcrumb" class="col-md-12">
                                        <ol class="breadcrumb">
                                                ...
                                                <li><a href="<?php echo Config::get('URL'); ?>leaflet/maplistscroller/<?php echo $data['area'] ?>/"><?php echo $data['area'] ?></a></li>
