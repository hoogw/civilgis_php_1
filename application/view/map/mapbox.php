                                            ...
                                            <div class="box">
                                                    ...
                                                    <div class="box-content">
                                                     ...
                                                     <!--   
                                                        ...
                                                        <button type="button" class="btn btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapbox/Denver/'">
                                                          ...
                                                          <button type="button" class="btn btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapbox/Aurora/'">
                                                          ...
                                                          <button type="button" class="btn btn-success" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapbox/Palo_Alto/'">
                                                          ...
                                                          <button type="button" class="btn btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapbox/Bakersfield/'">
                                                        ...
                                                        <button type="button" class="btn btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapbox/Chicago/'">
                                                         ...
                                                         <button type="button" class="btn btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapbox/county/'">
