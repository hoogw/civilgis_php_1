         ...
         <script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/mapsmps.js"></script>
	...
	<div class="row">
		<div id="sidebar-left" class="col-xs-2 col-sm-2">
			<ul class="nav main-menu">
                                ...
                                <li>
					<a href="<?php echo Config::get('URL'); ?>map/maplistscroller/newyork" >
						...
						<span class="hidden-xs">New York</span>
                                ...
                                <li>
					<a href="<?php echo Config::get('URL'); ?>map/maplistscroller/chicago" >
				...
				<li>
					<a href="<?php echo Config::get('URL'); ?>map/maplistscroller/losangeles" >
                        ...
                        <div class="row">
                                <div id="breadcrumb" class="col-md-12">
                                        <ol class="breadcrumb">
                                                ...
                                                <li><a href="<?php echo Config::get('URL'); ?>map/maplistscroller/<?php echo $data['area'] ?>/"><?php echo $data['area'] ?></a></li>
                                                
                                                <li><a href="<?php echo Config::get('URL'); ?>map/mapscroller/<?php echo $data['area'] ?>/<?php echo $data['subject'] ?>"><?php echo $data['subject'] ?></a></li>
                                        </ol>
                                </div>
                        </div>
