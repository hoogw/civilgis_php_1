                                            ...
                                            <div class="box">
                                                    ...
                                                    <div class="box-content">
                                                     ...
                                                     <!--   
                                                        ...
                                                        <button type="button" class="btn btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/leaflet/Denver/'">
                                                          ...
                                                          <button type="button" class="btn btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>home/leaflet/Aurora/'">
                                                          ...
                                                          <button type="button" class="btn btn-success" onclick="location.href = '<?php echo Config::get('URL'); ?>home/leaflet/Palo_Alto/'">
                                                          ...
                                                          <button type="button" class="btn btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/leaflet/Bakersfield/'">
                                                        ...
                                                        <button type="button" class="btn btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>home/leaflet/Chicago/'">
                                                         ...
                                                         <button type="button" class="btn btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>home/leaflet/county/'">
