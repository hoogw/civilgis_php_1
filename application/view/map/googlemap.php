		...
		<div id="content" class="col-xs-12 col-sm-10">
                         ...
                         <div class="col-xs-12 col-sm-12">
                                            <div class="box">
                                                    ...
                                                    <div class="box-content">
                                                         ...
                                                         <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Shoreline/'">
                            ...
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Santa_Monica'">
                            ...
                            <button type="button" class="btn btn-xs btn-success" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Palo_Alto/'">
                            ...
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Newport_Beach'">
                            ...
                            <button type="button" class="btn btn-xs btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/New_York'">
                            ...
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/San_Francisco'">
                                <img src="<?php echo Config::get('URL'); ?>public/images/logo/san_francisco.png" alt="" />
                            </button>

                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-xs btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Chicago'">
                            ...
                            <button type="button" class="btn btn-xs btn-danger" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Los_Angeles'">
                       ...
                       <!--     
                               ...
                               <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Stockton/'">
                                ...
                                <img src="<?php echo Config::get('URL'); ?>public/images/logo/stockton.png" />
                                 ...
                                 <button type="button" class="btn btn-xs btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Aurora/'">
                            ...
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Denver/'">
                            ...
                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-xs btn-success" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Seattle'">
                            ...
                            <button type="button" title="/Washington_DC" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Washington_DC/'">
                            ...
                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-xs btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Portland'">
                            ...
                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/San_Jose'">
                            ...
                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Orlando'">
                            ...
                            <button type="button" title="City of Bakersfield California" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Bakersfield/'">
                            ...
                            <button type="button" title="City of Philadelphia" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Philadelphia/'">
                            ...
                            <button type="button" title="Baltimore" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/Baltimore/'">
                             ...
                             <button type="button"  title="Orange County California" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/county'">
                            ...
                            <button type="button" class="btn btn-xs btn-success" onclick="location.href = '<?php echo Config::get('URL'); ?>home/googlemap/city'">Sample city</button>
                             &nbsp;&nbsp;
-->
