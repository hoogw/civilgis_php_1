		...
		<div id="content" class="col-xs-12 col-sm-10">
                        ...
                        <div class="row">
                                <div id="breadcrumb" class="col-md-12">
                                        <ol class="breadcrumb">
                                                ...
                                                <li> <a href="<?php echo Config::get('URL'); ?>map/mapboxgl">Mapbox GL</a></li> 
                       ...
                       <div class="row">
                         <div class="col-xs-12 col-sm-12">
                            ...
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/Santa_Monica'">
                            ...
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/San_Francisco'">
                                <img src="<?php echo Config::get('URL'); ?>public/images/logo/san_francisco.png" alt="" />
                            </button>

                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-xs btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/Chicago'">
                            ...
                            <button type="button" class="btn btn-xs btn-danger" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/Los_Angeles'">
        ...
        <!--                         
                               ...
                               <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/Stockton/'">
                                ...
                                <img src="<?php echo Config::get('URL'); ?>public/images/logo/stockton.png" />
                                 ...
                                 <button type="button" class="btn btn-xs btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/Aurora/'">
                            ...
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/Denver/'">
                            ...
                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-xs btn-success" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/Seattle'">
                            ...
                            <button type="button" title="/Washington_DC" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/Washington_DC/'">
                            ...
                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-xs btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/Portland'">
                            ...
                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/San_Jose'">
                            ...
                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/Orlando'">
                            ...
                            <button type="button" title="City of Bakersfield California" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/Bakersfield/'">
                            ...
                            <button type="button" title="City of Philadelphia" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/Philadelphia/'">
                            ...
                            <button type="button" title="Baltimore" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/Baltimore/'">
                             ...
                             <button type="button"  title="Orange County California" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/mapboxgl/county'">
