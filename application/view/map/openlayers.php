                         ...
                         <div class="col-xs-12 col-sm-12">
                                            <div class="box">
                                                    ...
                                                    <div class="box-content">
                                                         ...
                                                         <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Shoreline/'">
                            ...
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Santa_Monica'">
                            ...
                            <button type="button" class="btn btn-xs btn-success" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Palo_Alto/'">
                            ...
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Newport_Beach'">
                            ...
                            <button type="button" class="btn btn-xs btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/New_York'">
                            ...
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/San_Francisco'">
                                <img src="<?php echo Config::get('URL'); ?>public/images/logo/san_francisco.png" alt="" />
                            </button>

                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-xs btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Chicago'">
                            ...
                            <button type="button" class="btn btn-xs btn-danger" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Los_Angeles'">
      ...
      <!--                           
                               ...
                               <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Stockton/'">
                                ...
                                <img src="<?php echo Config::get('URL'); ?>public/images/logo/stockton.png" />
                                 ...
                                 <button type="button" class="btn btn-xs btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Aurora/'">
                            ...
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Denver/'">
                            ...
                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-xs btn-success" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Seattle'">
                            ...
                            <button type="button" title="/Washington_DC" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Washington_DC/'">
                            ...
                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-xs btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Portland'">
                            ...
                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/San_Jose'">
                            ...
                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Orlando'">
                            ...
                            <button type="button" title="City of Bakersfield California" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Bakersfield/'">
                            ...
                            <button type="button" title="City of Philadelphia" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Philadelphia/'">
                            ...
                            <button type="button" title="Baltimore" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/Baltimore/'">
                             ...
                             <button type="button"  title="Orange County California" class="btn btn-xs btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/county'">
                            ...
                            <button type="button" class="btn btn-xs btn-success" onclick="location.href = '<?php echo Config::get('URL'); ?>home/openlayers/city'">Sample city</button>
                             &nbsp;&nbsp;
-->
