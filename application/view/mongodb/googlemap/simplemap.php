...
<script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/mongodb/map_init/googlemap.js"></script>

<script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/mongodb/googlemap/simplemap.js"></script>
		...
		<div id="content" class="col-xs-12 col-sm-10">
                        ...
                        <div class="row">
                                <div id="breadcrumb" class="col-md-12">
                                        <ol class="breadcrumb">
                                                <li><a href="<?php echo Config::get('URL'); ?>map/mongodb/">TransparentGov </a></li>
                                                
                                             
                                                  <li><a href="<?php echo Config::get('URL'); ?>map/mongodb/">ArcGIS Server Rest API</a></li> 
                                                
                                               
                                               
                                                <li><a href="<?php echo Config::get('URL'); ?>home/mongodb/googlemap/<?php echo $data['area'] ?>/"><?php echo $data['area'] ?></a></li>
                                                
                                                <li><a href="<?php echo Config::get('URL'); ?>mongodb/simplemap/googlemap/<?php echo $data['area'] ?>/<?php echo $data['subject'] ?>"><?php echo $data['subject'] ?></a></li>
