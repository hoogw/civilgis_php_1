                         ...
                         <div class="col-xs-12 col-sm-12">
                                            <div class="box">
                                                    ...
                                                    <div class="box-content">
                                                            ...
                                                            <button type="button" class="btn btn-info"    onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/classifycheckboxbuttonmap/heremap/Los_Angeles/Zoning'">Zoning - check box </button>
                                                             &nbsp;&nbsp;
                                                            <button type="button" class="btn btn-info"    onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/classifyradiobuttonmap/heremap/Los_Angeles/Zoning'">Zoning - radio </button>
                                                        
                                                             &nbsp;&nbsp;
                                                            <button type="button" class="btn btn-primary" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/classifycheckboxbuttonmap/heremap/Los_Angeles/General_Land_Use'">General Land Use  - check box </button>
                                                         &nbsp;&nbsp;
                                                            <button type="button" class="btn btn-primary" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/classifyradiobuttonmap/heremap/Los_Angeles/General_Land_Use'">General Land Use  - radio </button>
...
">
   ...
   (3)   All such signs abutting a major or secondary highway or a heremap street shall be placed clear of the ultimate street dedication line determined in accordance with the current Standard Street Dimensions adopted by the City Planning Commission.
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                            <div class="box">
                                                    ...
                                                    <div class="box-content">
                                                        ...
                                                        <button type="button" class="btn btn-success"  onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerclienttablemap/heremap/Los_Angeles/Communities'">Communities</button>
                                                         &nbsp;&nbsp;
                                                        <button type="button" class="btn btn-success"  onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerclienttablemap/heremap/Los_Angeles/Neighborhood_Councils'">Neighborhood Councils</button>
                                                         &nbsp;&nbsp;
                                                         
                                                        <button type="button" class="btn btn-success"  onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerclienttablemap/heremap/Los_Angeles/Area_Planning_Commissions'">Area Planning Commissions</button>
                                                         &nbsp;&nbsp;
                                                        <button type="button" class="btn btn-success"  onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerclienttablemap/heremap/Los_Angeles/Communities_And_Planning_Areas'">Communities and Planning Areas</button>
                                                         &nbsp;&nbsp;
                                                         <button type="button" class="btn btn-success"  onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerclienttablemap/heremap/Los_Angeles/Specific_Plans'">Specific Plans</button>
                                                        &nbsp;&nbsp;
                                                         <button type="button" class="btn btn-success"  onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerclienttablemap/heremap/Los_Angeles/Other_Districts'">Other Districts</button>
                                                        &nbsp;&nbsp;
                                                        
                                                        <button type="button" class="btn btn-success"  onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerclienttablemap/heremap/Los_Angeles/Historic_Preservation_Overlay_Zone'">Historic Preservation Overlay Zone</button>
                                                         &nbsp;&nbsp;
                                                        <button type="button" class="btn btn-success"  onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerclienttablemap/heremap/Los_Angeles/Historic_Cultural_Monuments'">Historic Cultural Monuments</button>
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                            <div class="box">
                                                    ...
                                                    <div class="box-content">
                                                         ...
                                                         <button type="button" class="btn btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/simplemap/heremap/Los_Angeles/Federal_Renewal_Community'">Federal Renewal Community</button>
                                                          &nbsp;&nbsp;<button type="button" class="btn btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/simplemap/heremap/Los_Angeles/State_Enterprise_Zone'">State Enterprise Zone</button>
                                                         &nbsp;&nbsp; <button type="button" class="btn btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/simplemap/heremap/Los_Angeles/Business_Improvement_District'">Business Improvement District</button>
                                                          &nbsp;&nbsp;<button type="button" class="btn btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/simplemap/heremap/Los_Angeles/Targeted_Neighborhood_Initiative'">Targeted Neighborhood Initiative</button>
