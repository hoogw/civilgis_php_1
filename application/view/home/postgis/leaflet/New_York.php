                         ...
                         <div class="col-xs-12 col-sm-12">
                                            <div class="box">
                                                    ...
                                                    <div class="box-content">
                                                         ...
                                                         <button type="button" class="btn btn-success" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/classifycheckboxbuttonmap/leaflet/New_York/Zone_Districts'">New York Zone Districts - check box </button>
                                                        
                                                            &nbsp;&nbsp;
                                                            
                                                        <button type="button" class="btn btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/classifyradiobuttonmap/leaflet/New_York/Zone_Districts'">New York Zone Districts - radio </button>
                                                        
                                                            &nbsp;&nbsp;
                                                        
                                                            
                                                            
                                                             <button type="button" class="btn btn-primary" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/classifycheckboxbuttonmap/leaflet/New_York/Commercial_Zone'">New York Commercial Zone - check box </button>
                                                        
                                                            &nbsp;&nbsp;
                                                            
                                                        <button type="button" class="btn btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/classifyradiobuttonmap/leaflet/New_York/Commercial_Zone'">New York Commercial Zone - radio </button>
                                                        ...
                                                        <br>
                                                            ...
                                                            <button type="button" class="btn btn-danger" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/classifycheckboxbuttonmap/leaflet/New_York_Manhattan/Zoning'">Manhattan Zoning - check box </button>
                                                        
                                                            &nbsp;&nbsp;
                                                            
                                                            
                                                             <button type="button" class="btn btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/classifyradiobuttonmap/leaflet/New_York_Manhattan/Zoning'">Manhattan Zoning - radio </button>
                                                        
                                                            &nbsp;&nbsp;
                                                            
                                                            
                                                       
                                                            <button disabled="disabled" type="button" class="btn btn-default"    onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/classifycheckboxbuttonmap/leaflet/New_York_Bronx/Zoning'">Bronx Zoning </button>
                                                            
                                                            &nbsp;&nbsp;
                                                            
                                                            <button disabled="disabled" type="button" class="btn btn-default"    onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/classifyradiobuttonmap/leaflet/New_York_Brooklyn/Zoning'">Brooklyn Zoning  </button>
                                                        
                                                            &nbsp;&nbsp;
                                                            
                                                            <button disabled="disabled" type="button" class="btn btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/classifyradiobuttonmap/leaflet/New_York_Queens/Zoning'">Queens Zoning  </button>
                                                       
                                                            &nbsp;&nbsp;
                                                            <button disabled="disabled" type="button" class="btn btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/classifycheckboxbuttonmap/leaflet/New_York_Staten_Island/Zoning'">Staten Island Zoning </button>
...
The floor area ratio of 10.0 may be increased to 12.0 if affordable housing is provided pursuant to the Inclusionary Housing Program, or if a publicly accessible plaza along a narrow street. Plazas are permitted only in buildings with a commercial community facility base. The building base must be between 60 and 85 feet high and extend along the entire frontage of a wide street. A tower is permitted above 85 feet provided it is set back at least 10 feet from a wide street and at least 15 feet from a narrow street. To prevent excessively tall and narrow towers, a tower must have a minimum lot coverage of 33%. No parking is required.">
					                       ...
					                       Commercial Districts
                                                   ...
                                                   <div class="well">
                                                        ...
                                                        <a class="fancybox"  title="C1 & C2 (C1-1, C1-2, C1-3, C1-4, C1-5) & (C2-1, C2-2, C2-3, C2-4, C2-5) - C1-1 through C1-5 and C2-1 through C2-5 districts are mapped as commercial overlays within residence districts. They are mapped along streets that serve the leaflet retail needs of the surrounding residential neighborhood, and are found exclusively throughout the city's lower- and medium-density areas, and occasionally in higher-density areas. 
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                            <div class="box">
                                                    ...
                                                    <div class="box-content">
                                                            ...
                                                            <button type="button" class="btn btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerfulltablemap/leaflet/New_York_Manhattan/Zoning'">Parcels - Manhattan </button>
                                                             &nbsp;&nbsp;
                                                             
                                                           <button disabled="disabled" type="button" class="btn btn-default"    onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/pagedfulltablemap/leaflet/New_York_Bronx/Zoning'">Parcels - Bronx </button>
                                                            
                                                           
                                                            &nbsp;&nbsp;
                                                            <button disabled="disabled" type="button" class="btn btn-default"    onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerfulltablemap/leaflet/New_York_Brooklyn/Zoning'">Parcels - Brooklyn </button>
                                                        
                                                            
                                                        
                                                            &nbsp;&nbsp;
                                                            <button disabled="disabled" type="button" class="btn btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerfulltablemap/leaflet/New_York_Queens/Zoning'">Parcels - Queens  </button>
                                                       
                                                            &nbsp;&nbsp;
                                                            <button disabled="disabled" type="button" class="btn btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerfulltablemap/leaflet/New_York_Staten_Island/Zoning'">Parcels - Staten Island  </button>
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                            <div class="box">
                                                    ...
                                                    <div class="box-content">
                                                        ...
                                                        <button  type="button" class="btn btn-info"    onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerfulltablemap/leaflet/New_York/Project_Zone'">New York Project Zone </button>
                                                            
                                                           
                                                            &nbsp;&nbsp;
                                                         
                                                            <button type="button" class="btn btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerfulltablemap/leaflet/New_York/Limited_Height_District'">New York Limited Height District </button>
                                                             &nbsp;&nbsp;
                                                             
                                                           
                                                            <button  type="button" class="btn btn-info"    onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerfulltablemap/leaflet/New_York/Special_Districts'">New York Special Districts </button>
                                                        
                                                            
                                                        
                                                            &nbsp;&nbsp;
                                                            <button  type="button" class="btn btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerfulltablemap/leaflet/New_York/Special_Subdistricts'">New York Special Subdistricts  </button>
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                            <div class="box">
                                                    ...
                                                    <div class="box-content">
                                                        ...
                                                        <button  type="button" class="btn btn-primary"    onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/simplemap/leaflet/New_York/Boroughs'">New York Boroughs </button>
                                                            
                                                           
                                                            &nbsp;&nbsp;
                                                         
                                                            <button type="button" class="btn btn-primary" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerclienttablemap/leaflet/New_York/Neighborhoods'">New York Neighborhoods</button>
                                                             &nbsp;&nbsp;
                                                             
                                                           
                                                            <button  type="button" class="btn btn-primary"    onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerclienttablemap/leaflet/New_York/Community_Districts'">New York Community Districts </button>
                                                        &nbsp;&nbsp;
                                                        
                                                        
                                                        <br>
                                                        
                                                        <button  type="button" class="btn btn-info"    onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/simplemap/leaflet/New_York/Building_Demolition'">New York Building Demolition </button>
                                                            
                                                           
                                                            &nbsp;&nbsp;
                                                        
                                                            
                                                            <button  type="button" class="btn btn-info"    onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/justtiles/leaflet/New_York/Building'">New York Building </button>
                                                            ...
                                                            <button  type="button" class="btn btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerfulltablemap/leaflet/New_York/Parks'">New York Parks  </button>
                                                        &nbsp;&nbsp;
                                                        
                                                        <button  type="button" class="btn btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/simplemap/leaflet/New_York/Parking_Lots'">New York Parking Lots  </button>
                                                        &nbsp;&nbsp;
                                                            
                                                        
                                                        
                                                         <button disabled="disabled" type="button" class="btn btn-default"    onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerfulltablemap/leaflet/New_York/Address'"> New York Address</button>
                                                        
                                                            &nbsp;&nbsp;
                                                        
                                                        <button disabled="disabled" type="button" class="btn btn-default"    onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerfulltablemap/leaflet/New_York/Streets'"> New York Streets</button>
                                                        
                                                            &nbsp;&nbsp;
                                                            
                                                            
                                                             <button disabled="disabled" type="button" class="btn btn-default"    onclick="location.href = '<?php echo Config::get('URL'); ?>postgis/scrollerfulltablemap/leaflet/New_York/Sidewalk'"> New York Sidewalk</button>
