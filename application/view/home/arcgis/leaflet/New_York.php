                         ...
                         <div class="col-xs-12 col-sm-12">
                                            <div class="box">
                                                    ...
                                                    <div class="box-content">
                                                         ...
                                                         <button type="button" class="btn btn-success" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/classifycheckboxbuttonmap/leaflet/New_York/Zone_Districts'">New York Zone Districts - check box </button>
                                                        
                                                            &nbsp;&nbsp;
                                                            
                                                        <button type="button" class="btn btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/classifyradiobuttonmap/leaflet/New_York/Zone_Districts'">New York Zone Districts - radio </button>
                                                        
                                                            &nbsp;&nbsp;
                                                        
                                                            
                                                            
                                                             <button type="button" class="btn btn-primary" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/classifycheckboxbuttonmap/leaflet/New_York/Commercial_Zone'">New York Commercial Zone - check box </button>
                                                        
                                                            &nbsp;&nbsp;
                                                            
                                                        <button type="button" class="btn btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/classifyradiobuttonmap/leaflet/New_York/Commercial_Zone'">New York Commercial Zone - radio </button>
                                                        ...
                                                        <br>
                                                            ...
                                                            <button type="button" class="btn btn-danger" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/classifycheckboxbuttonmap/leaflet/New_York_Manhattan/Zoning'">Manhattan Zoning - check box </button>
                                                        
                                                            &nbsp;&nbsp;
                                                            
                                                            
                                                             <button type="button" class="btn btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/classifyradiobuttonmap/leaflet/New_York_Manhattan/Zoning'">Manhattan Zoning - radio </button>
                                                        
                                                            &nbsp;&nbsp;
                                                            
                                                            
                                                       
                                                            <button disabled="disabled" type="button" class="btn btn-default"    onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/classifycheckboxbuttonmap/leaflet/New_York_Bronx/Zoning'">Bronx Zoning </button>
                                                            
                                                            &nbsp;&nbsp;
                                                            
                                                            <button disabled="disabled" type="button" class="btn btn-default"    onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/classifyradiobuttonmap/leaflet/New_York_Brooklyn/Zoning'">Brooklyn Zoning  </button>
                                                        
                                                            &nbsp;&nbsp;
                                                            
                                                            <button disabled="disabled" type="button" class="btn btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/classifyradiobuttonmap/leaflet/New_York_Queens/Zoning'">Queens Zoning  </button>
                                                       
                                                            &nbsp;&nbsp;
                                                            <button disabled="disabled" type="button" class="btn btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/classifycheckboxbuttonmap/leaflet/New_York_Staten_Island/Zoning'">Staten Island Zoning </button>
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                            <div class="box">
                                                    ...
                                                    <div class="box-content">
                                                            ...
                                                            <button type="button" class="btn btn-warning" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/scrollerfulltablemap/leaflet/New_York_Manhattan/Zoning'">Parcels - Manhattan </button>
                                                             &nbsp;&nbsp;
                                                             
                                                           <button disabled="disabled" type="button" class="btn btn-default"    onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/pagedfulltablemap/leaflet/New_York_Bronx/Zoning'">Parcels - Bronx </button>
                                                            
                                                           
                                                            &nbsp;&nbsp;
                                                            <button disabled="disabled" type="button" class="btn btn-default"    onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/scrollerfulltablemap/leaflet/New_York_Brooklyn/Zoning'">Parcels - Brooklyn </button>
                                                        
                                                            
                                                        
                                                            &nbsp;&nbsp;
                                                            <button disabled="disabled" type="button" class="btn btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/scrollerfulltablemap/leaflet/New_York_Queens/Zoning'">Parcels - Queens  </button>
                                                       
                                                            &nbsp;&nbsp;
                                                            <button disabled="disabled" type="button" class="btn btn-default" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/scrollerfulltablemap/leaflet/New_York_Staten_Island/Zoning'">Parcels - Staten Island  </button>
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                            <div class="box">
                                                    ...
                                                    <div class="box-content">
                                                        ...
                                                        <button  type="button" class="btn btn-info"    onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/scrollerfulltablemap/leaflet/New_York/Project_Zone'">New York Project Zone </button>
                                                            
                                                           
                                                            &nbsp;&nbsp;
                                                         
                                                            <button type="button" class="btn btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/scrollerfulltablemap/leaflet/New_York/Limited_Height_District'">New York Limited Height District </button>
                                                             &nbsp;&nbsp;
                                                             
                                                           
                                                            <button  type="button" class="btn btn-info"    onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/scrollerfulltablemap/leaflet/New_York/Special_Districts'">New York Special Districts </button>
                                                        
                                                            
                                                        
                                                            &nbsp;&nbsp;
                                                            <button  type="button" class="btn btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/scrollerfulltablemap/leaflet/New_York/Special_Subdistricts'">New York Special Subdistricts  </button>
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                            <div class="box">
                                                    ...
                                                    <div class="box-content">
                                                        ...
                                                        <button  type="button" class="btn btn-primary"    onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/simplemap/leaflet/New_York/Boroughs'">New York Boroughs </button>
                                                            
                                                           
                                                            &nbsp;&nbsp;
                                                         
                                                            <button type="button" class="btn btn-primary" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/scrollerclienttablemap/leaflet/New_York/Neighborhoods'">New York Neighborhoods</button>
                                                             &nbsp;&nbsp;
                                                             
                                                           
                                                            <button  type="button" class="btn btn-primary"    onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/scrollerclienttablemap/leaflet/New_York/Community_Districts'">New York Community Districts </button>
                                                        &nbsp;&nbsp;
                                                        
                                                        
                                                        <br>
                                                        
                                                        <button  type="button" class="btn btn-info"    onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/simplemap/leaflet/New_York/Building_Demolition'">New York Building Demolition </button>
                                                            
                                                           
                                                            &nbsp;&nbsp;
                                                        
                                                            
                                                            <button  type="button" class="btn btn-info"    onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/justtiles/leaflet/New_York/Building'">New York Building </button>
                                                            ...
                                                            <button  type="button" class="btn btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/scrollerfulltablemap/leaflet/New_York/Parks'">New York Parks  </button>
                                                        &nbsp;&nbsp;
                                                        
                                                        <button  type="button" class="btn btn-info" onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/simplemap/leaflet/New_York/Parking_Lots'">New York Parking Lots  </button>
                                                        &nbsp;&nbsp;
                                                            
                                                        
                                                        
                                                         <button disabled="disabled" type="button" class="btn btn-default"    onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/scrollerfulltablemap/leaflet/New_York/Address'"> New York Address</button>
                                                        
                                                            &nbsp;&nbsp;
                                                        
                                                        <button disabled="disabled" type="button" class="btn btn-default"    onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/scrollerfulltablemap/leaflet/New_York/Streets'"> New York Streets</button>
                                                        
                                                            &nbsp;&nbsp;
                                                            
                                                            
                                                             <button disabled="disabled" type="button" class="btn btn-default"    onclick="location.href = '<?php echo Config::get('URL'); ?>arcgis/scrollerfulltablemap/leaflet/New_York/Sidewalk'"> New York Sidewalk</button>
