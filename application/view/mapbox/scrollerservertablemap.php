        ...
        <script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/map_init/mapbox.js"></script>
         ...
         <script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/mapbox/scrollerservertablemap.js"></script>
		...
		<div id="content" class="col-xs-12 col-sm-10">
                        ...
                        <div class="row">
                                <div id="breadcrumb" class="col-md-12">
                                        <ol class="breadcrumb">
                                                <li><a href="<?php echo Config::get('URL'); ?>map/mapbox/">TransparentGov</a></li>
                                                
                                                <li><a href="<?php echo Config::get('URL'); ?>home/mapbox/<?php echo $data['area'] ?>"><?php echo $data['area'] ?></a></li> 
                                                
                                                <li><a href="<?php echo Config::get('URL'); ?>mapbox/scrollerservertablemap/<?php echo $data['area'] ?>/<?php echo $data['subject'] ?>"><?php echo $data['subject'] ?></a></li>
                                        </ol>
                                </div>
                        </div>
