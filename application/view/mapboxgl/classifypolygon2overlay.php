...
<script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/mapboxgl/classifypolygon2overlay.js"></script>
    ...
    <input type="hidden" id="subjectID" value=<?php echo $data['subject'] ?>></input>
     ...
     <input type="hidden" id="overlay2ID" value=<?php echo $data['overlay2'] ?>></input>
