...
<script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/mapboxgl/singlelayersimplehighlightgeojsonmap.js"></script>
                        ...
                        <div class="row">
                                <div id="breadcrumb" class="col-md-12">
                                        <ol class="breadcrumb">
                                                ...
                                                <li><a href="<?php echo Config::get('URL'); ?>mapboxgl/singlelayersimplehighlightgeojsonmap/<?php echo $data['area'] ?>/<?php echo $data['subject'] ?>"><?php echo $data['subject'] ?></a></li>
                                        </ol>
                                </div>
                        </div>
