...
<script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/arcgis/leaflet/clusterpagedclienttablemap.js"></script>
                                        ...
                                        <ol class="breadcrumb">
                                              <li><a href="<?php echo Config::get('URL'); ?>map/index/">Transparent Gov</a></li>
                                               ...
                                               <li><a href="<?php echo Config::get('URL'); ?>home/arcgis/leaflet/<?php echo $data['area'] ?>/"><?php echo $data['area'] ?></a></li>
                                                ...
                                                <li><a href="<?php echo Config::get('URL'); ?>arcgis/clusterpagedclienttablemap/leaflet/<?php echo $data['area'] ?>/<?php echo $data['subject'] ?>"><?php echo $data['subject'] ?></a></li>
                                        </ol>
                                </div>
                        </div>
