...
<link href="<?php echo Config::get('URL'); ?>public/js/map_api/leaflet_GeoSearch/css/l.geosearch.css" rel="stylesheet" />
        ...
        <script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/arcgis/map_init/leaflet.js"></script>
         ...
         <script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/arcgis/leaflet/pagedservertablemap.js"></script>
                        ...
                        <div class="row">
                                <div id="breadcrumb" class="col-md-12">
                                        <ol class="breadcrumb">
                                                ...
                                                <li><a href="<?php echo Config::get('URL'); ?>arcgis/pagedservertablemap/leaflet/<?php echo $data['area'] ?>/<?php echo $data['subject'] ?>"><?php echo $data['subject'] ?></a></li>
                                        </ol>
                                </div>
                        </div>
