...
<script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/vg/map_init/leaflet.js"></script>
<script type="text/javascript" src="<?php echo Config::get('URL'); ?>public/js/vg/leaflet/simplemap.js"></script>
                        ...
                        <div class="row">
                                <div id="breadcrumb" class="col-md-12">
                                        <ol class="breadcrumb">
                                                ...
                                                <li><a href="<?php echo Config::get('URL'); ?>map/vg/">Arcgis Rest API Home</a></li> 
                                               
                                                <li><a href="<?php echo Config::get('URL'); ?>home/vg/leaflet/<?php echo $data['area'] ?>/"><?php echo $data['area'] ?></a></li>
                                                
                                                <li><a href="<?php echo Config::get('URL'); ?>vg/simplemap/leaflet/<?php echo $data['area'] ?>/<?php echo $data['subject'] ?>"><?php echo $data['subject'] ?></a></li>
                                        </ol>
                                </div>
                        </div>
