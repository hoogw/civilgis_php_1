...
function get_map_bound(){
      ...
      //document.getElementById("title_info").innerHTML = "MAP BOUNDS [SouthWest, NorthEast] "+ map.getBounds();
            ...
            // http://services3.arcgis.com/VILr8UqX00eNAkeO/arcgis/rest/services/city_online/FeatureServer
            ...
            var _url='http://services3.arcgis.com/VILr8UqX00eNAkeO/arcgis/rest/services/city_online/FeatureServer/query?layerDefs={"10":""}&returnGeometry=true&f=json&geometryType=esriGeometryEnvelope&geometry='+ _envelope;
