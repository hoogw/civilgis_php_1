                        ...
                        if(isNaN(data)){
                          ...
                          //gmap.data.loadGeoJson(_apiURI);
                           ...
                           //myLayer.loadGeoJson(_apiURI);
                            ...
                            _total_current_json = Object.keys(_geojson_object.features).length;
                            
                            if (_total_current_json< 3000){
                                 map.data.addGeoJson(_geojson_object);
                            }
                             else {
                                 
                                 myLayer.loadData(_geojson_object);
                                 myLayer.start();
