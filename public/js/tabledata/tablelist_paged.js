       ...
       /* test ajax result before feed into datatable
        ...
        test end */
                                                            ...
                                                            "ajax":{
                                                                ...
                                                                "columns": [
                                                                            ...
                                                                            { "data": "table_name",
                                                                                    ...
                                                                                    $(nTd).html("<a href='" + base_url+ "data/tablepaged/"+ _area + "/" + trunk_table_name+"'>"+oData.table_name+"</a>");
                                                                                }
                                                                            }]
                                                                */
                                                                ...
                                                                "columnDefs": [ {
                                                                                    ...
                                                                                    "render": function ( data, type, full, meta ) {
                                                                                      ...
                                                                                      return '<a href="'+ base_url+'data/tablepaged/'+ _area + '/' +trunk_name+'">' + data + '</a>';
                                                                                    }
                                                                                  } ]
               ...
               $('#tabledata tbody').on('click', 'tr', function () {
                                                                        ...
                                                                        var _url_new_tab = base_url+ "data/tablepaged/"+ _area + "/"+ trunk_name + "/";
